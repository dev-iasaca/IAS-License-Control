...
async function lookupJobFamilyId(name: string | undefined | null): Promise<number | null> {
...
export const LICENSES: License[] = [
  { no: 1, nik: '124700019', name: 'Udi Suprianto', licenseName: 'ADVANCE HUMAN CAPITAL ACCOMPLISHED (AHCA)', instansi: 'ATMA JAYA', startDate: '19 Januari 2025', endDate: '26 Februari 2025', jobFamily: 'People Management', organization: 'PT Integrasi Aviasi Solusi' },
  ...
  { no: 3, nik: '124860490', name: 'Radite Aranditya Hermanus', licenseName: 'Sertifikat Kompetensi General Manager SDM', instansi: 'BNSP', startDate: '11 November 2024', endDate: '10 November 2027', jobFamily: 'JF-03034', organization: 'PT Integrasi Aviasi Solusi' },
  { no: 4, nik: '124860490', name: 'Radite Aranditya Hermanus', licenseName: 'Advanced Human Capital Accomplished (AHCA)', instansi: 'Atma Jaya', startDate: '19 Januari 2025', endDate: '15 Maret 2025', jobFamily: 'JF-03034', organization: 'PT Integrasi Aviasi Solusi' },
  { no: 5, nik: '124900596', name: 'Antin Putri Permatasari', licenseName: 'Metodologi Instruktur', instansi: 'BNSP', startDate: '18 Agustus 2022', endDate: '18 Agustus 2025', jobFamily: 'Customer Service Management', organization: 'PT Integrasi Aviasi Solusi' },
  { no: 6, nik: '124740078', name: 'Luh Putu Eka Aryani', licenseName: 'Certified Sustainability Reporting Specialist (CSRS)', instansi: 'FORUM TJSL BUMN', startDate: '20 Mei 2025', endDate: '22 Mei 2025', jobFamily: 'Corporate Relation And Communication', organization: 'PT Integrasi Aviasi Solusi' },
